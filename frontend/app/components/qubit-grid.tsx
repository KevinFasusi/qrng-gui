...
const QubitGridPageComponent = ({num}: { num: number }) => {

    const qubitArray: number[] = [...Array(num)];

    return (qubitArray.map((_, index,) => {
            index += 1;
            return (<>
                <div className="grid-item">
                    <div className="flex justify-center flex-row bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                        ...
                        Qubit {index.toString()}
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" viewBox="0 0 24 24">
                                <circle cx={12} cy={12} r={0} fill="green">
                                    <animate id="svgSpinnersPulseMultiple0" fill="freeze" attributeName="r"
                                             ...
                                             keySplines=".52,.6,.25,.99" values="0;11"></animate>
                                    <animate fill="freeze" attributeName="opacity"
                                             begin="0;svgSpinnersPulseMultiple2.end"
                                             calcMode="spline" dur="1.2s" keySplines=".52,.6,.25,.99"
                                             values="1;0"></animate>
                                </circle>
                                <circle cx={12} cy={12} r={0} fill="green">
...
export default QubitGridPageComponent;